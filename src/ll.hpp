...
template <typename ElementType>
LinkedListNode<ElementType>::LinkedListNode(ElementType data,
                                            LinkedListNode<ElementType> *next) {
    data_ = data;
    next_ = next;
}

template <typename ElementType>
bool LinkedListNode<ElementType>::operator!=(
    const LinkedListNode<ElementType> &node) const {
...
void LinkedList<ElementType>::PushFront(ElementType value) {
    LinkedListNode<ElementType> *temp =
        new LinkedListNode<ElementType>(value, head_);
    head_ = temp;
    size_++;
    delete temp;
}
...
std::ostream &operator<<(std::ostream &os,
    ...
    if (list.begin() == nullptr) {
        ...
        for (typename LinkedList<ElementType>::const_iterator itr =
                 list.begin();
             itr != list.end(); ++itr) {
            os << *itr << " ";
        }
